module github.com/theplant/myadmin

go 1.23.0

require (
	github.com/qor5/admin v1.0.0
	github.com/qor5/ui v1.0.1
...
require (
	...
	github.com/qor5/x v1.2.1-0.20231025063809-3344ed4b91f3 // indirect
